package santanderjavabootcamp.collectionseclassesuteis.continuacaoapistreams;

import santanderjavabootcamp.collectionseclassesuteis.continuacaoapistreams.domain.Contact;
import santanderjavabootcamp.collectionseclassesuteis.continuacaoapistreams.domain.Sex;
import santanderjavabootcamp.collectionseclassesuteis.continuacaoapistreams.domain.User;

import java.util.ArrayList;
import java.util.Comparator;
import java.util.List;

import static santanderjavabootcamp.collectionseclassesuteis.continuacaoapistreams.domain.ContactType.EMAIL;
import static santanderjavabootcamp.collectionseclassesuteis.continuacaoapistreams.domain.ContactType.PHONE;
